...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            $_SESSION['login_feedback'] = "Login successful! Welcome, " . $row['name'] . ".";
            header('Location: index2.php');
            exit;
        } else {
            $login_feedback = "Invalid password.";
        }
    } else {
...
<body>
    ...
    <script>
        var loginFeedback = "<?php echo $login_feedback; ?>";
        if (loginFeedback !== '') {
